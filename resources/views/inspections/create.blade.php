                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form method="GET" action="{{ route('inspections.create') }}">
                        <div class="flex items-center space-x-4">
                            <div class="flex-grow">
                                <select name="product_id" id="product_id" class="block w-full rounded-md border-gray-300 shadow-sm" required>
                        ...
                        <div class="p-6 text-gray-900">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8 p-4 border rounded-lg">
                                <div>
                                    ...
                                    <input type="number" name="quantity_total" id="quantity_total" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" required>
                                </div>
                                <div>
                                    <label for="quantity_pass" class="block text-sm font-medium text-gray-700">Jumlah Lulus (Pass)</label>
                                    <input type="number" name="quantity_pass" id="quantity_pass" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" required>
                                </div>
                                <div>
                                    <label for="quantity_fail" class="block text-sm font-medium text-gray-700">Jumlah Gagal (Fail)</label>
                                    <input type="number" name="quantity_fail" id="quantity_fail" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" required>
                                </div>
                            </div>
